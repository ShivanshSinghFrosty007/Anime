...
public class EpisodeSelector2 extends AppCompatActivity {

    LinearLayout buttonLayout;

    int maxEp;
    String id, type, epNo, p_id;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_episode_selector2);
        imageView = findViewById(R.id.sele_img_2);
        textView = findViewById(R.id.sele_name_2);
        ...
        myRef = database.getReference("Anime").child("categories").child(p_id).child("item").child(id);
        ...
        buttonLayout = findViewById(R.id.button_layout_2);
